...
capability the agent has, not a guarantee the chain uses: the
extraction tiers read a mock set as source, the same as any other
input role (`systems/platform_content.md`'s ORC-110 entry).
