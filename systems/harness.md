...
- **#2 Sampler axes come from upstream of the iterated tier, never
  ...
  alphabetical fill.
- **#3 Fresh-mode wipes are destructive by design and say so** — "what
  ...
  surprise.
- **#4 Campaigns never touch the pipeline** (v5 §10.2): candidates and
...
- **#5 Candidates run under the tier's production executor** (v5
...
- **#6 Budget-capped by construction**: dispatch-count caps for agent
  ...
  a choice.
- **#7 Harnessability is a property of the runtime abstractions** —
