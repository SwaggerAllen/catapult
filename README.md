...
`systems/delivery.md`) — both paths sit behind one hand-wired plug
(`Catapult.Foundation.DispatchPlug`), not a general router. The live
app's own specifics — name, region, public hostname, port, autodeploy,
the migrate PRE_DEPLOY job, the id of the app deploy detection watches
